...
public class Util_Check_Venue_Parameter {
	...
	public static Map<String, String[]> checkVenueMap(Map<String, String[]> map, Map<String,String> errorMsgs) {
		map = checkVenueV_no(map, errorMsgs);
		return map;
	}
	public static Map<String, String[]> checkVenueV_no(Map<String, String[]> map, Map<String,String> errorMsgs) {
		...
		if(map.containsKey(key_v_no)) {
			...
			if(v_no == null || v_no.trim().length()==0) {
				...
				errorMsgs.put(key_v_no,"查無此編號---場地編號，格式不符，如:V000001");
				map.remove(key_v_no);
			}
		}
		return map;
