	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("getOne_For_Update".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			try {
				...
				RequestDispatcher failureView = req
						.getRequestDispatcher("front-end/club/listAllEmp.jsp");
				failureView.forward(req, res);
			}
		}
...
//				clubVO.setPhoto(photo);
				...
				/***************************2.開始修改資料*****************************************/
				ClubService clubSvc = new ClubService();
				clubVO = clubSvc.updateClub(club_no, sp_no, null,null, club_status, club_name,club_intro);
...
//				clubVO.setPhoto(photo);
				...
				/***************************2.開始新增資料***************************************/
				ClubService clubSvc = new ClubService();
				clubVO = clubSvc.addClub(sp_no,null,photo_ext, club_status, club_name, club_intro);
